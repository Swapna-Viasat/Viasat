...
public class LocationUtils extends Service implements LocationListener {
        ...
        try {
            ...
            if (!isGPSEnabled && !isNetworkEnabled) {
                ...
                if (isNetworkEnabled) {
                    ...
                    LogUtils.debug("Network", "Network");
                ...
                if (isGPSEnabled) {
                    if (location == null) {
                        locationManager.requestLocationUpdates(
                                ...
                                MIN_TIME_BW_UPDATES,
                                MIN_DISTANCE_CHANGE_FOR_UPDATES, this);
                        LogUtils.debug("GPS Enabled", "GPS Enabled");
                        if (locationManager != null) {
                            location = locationManager
    ...
    public void showSettingsAlert(){
        ...
        alertDialog.setMessage("eTRAC requires service coordinates for reporting. Please allow eTRAC access to  GPS on your mobile.");
